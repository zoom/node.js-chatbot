...
var _UserToken2 = _interopRequireDefault(_UserToken);
...
let configNewUser = function () {
  ...
  this.refreshTokenCallback = null; // this.expire_start = null;
...
class Oauth2 extends _UserToken2.default {
  ...
  connect() {
    ...
    ():UserToken
    */
    return createUser(configNewUser, this)(); // return new UserToken(this);
  }
